...
Description: Negates the values of the tensor.
...
Conclusion: Compared with GPU, Ascend lacks support for uint, fp64, and bool types.
...
Compared with GPU, Ascend lacks support for uint, fp64, and bool types.

### 2.4 Usage

The following example performs element-wise negation on the input tensor `x`:
