...
Description: Atomic logical OR operation, which performs a logical OR (|) operation at the specified memory location
Prototype:
...
| `val`       | `pointer.dtype.element_ty`    | The value used for the atomic operation (right operand)                                                        |
...
The following example implements atomic OR:
