...
Conclusion: Compared with GPU, Ascend additionally supports fp16 and bf16.
...
The following example performs the element-wise exact division of the input tensors `x` and `y`:
