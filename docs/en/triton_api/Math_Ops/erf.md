...
Compared with GPU, Ascend lacks fp64 support but additionally supports fp16 and bf16.

### 2.4 Usage Example

The following example performs the element-wise error function computation on the input tensor `x`:
