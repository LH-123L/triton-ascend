...
Description: Subtraction, the '-' arithmetic operation; there is no tl.sub method
...
Return Value:
`tl.tensor`: The subtraction result
...
The following example performs the subtraction operation on the input tensors `in_ptr0, in_ptr1`:
